...
<div class="form-group row no-gutter">
    <div class="col-xs-7">
    <input type="text" 
       class="form-control b-r-0 item-price" 
       id="price-<?php echo $item['d_id']; ?>" 
    ...
    <div class="col-xs-4">
        <div style="display: flex; align-items: center;">
            <button type="button" onclick="updateQuantity(<?php echo $item['d_id']; ?>, -1)" style="width:30px;">−</button>
            <input type="text" id="quantity-<?php echo $item['d_id']; ?>" name="quantities[<?php echo $item['d_id']; ?>]" value="<?php echo $item['quantity']; ?>" readonly style="text-align:center; width: 40px; margin: 0 5px;">
            <button type="button" onclick="updateQuantity(<?php echo $item['d_id']; ?>, 1)" style="width:30px;">+</button>
        </div>
    </div>
...
?>								  
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        <p>TOTAL</p>
                                        <h3 class="value">₹<span id="total-price"><?php echo $item_total; ?></span></h3>
                                        <p>Free Delivery!</p>
                                        <?php
                                        if($item_total==0){
                                        ?>
                                        ...
                                        ?>
                                        <a href="checkout.php?res_id=<?php echo $_GET['res_id'];?>&action=check" id="checkout-btn" class="btn btn-success btn-lg active">Checkout</a>
                                        <?php   
                                        }
                                        ?>
